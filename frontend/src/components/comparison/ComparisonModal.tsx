  ...
  return (
    <div className="flex items-center gap-3">
      <div className="relative">
        ...
        />
        <div className="relative w-12 h-12 rounded-full overflow-hidden ring-2 ring-border shadow-inner flex items-center justify-center bg-secondary text-sm font-semibold">
          {player.photoUrl ? (
              ...
              <div className="grid md:grid-cols-2 gap-5 mt-6">
                ...
                <div className="rounded-xl border border-border/60 p-4 bg-secondary/40">
                  ...
                  <p className="text-xs text-muted-foreground mt-3">
                    Tip: Filter the main list first for faster search. Only season totals are compared.
                  </p>
                </div>
              </div>
            ) : (
